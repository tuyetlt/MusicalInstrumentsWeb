...
if ($('#categoryname') && $('#categoryid') && $('#drArticleCategory')) {
    var text_value = $('#categoryname');
    var id_value = $('#categoryid');
    var multilevel = $('#drArticleCategory').attr("data-level");
    ...
    if (text_value.val() !== undefined && id_value.val() !== undefined) {
        ...
        $("#drArticleCategory").select2({
            tags: true,
            tokenSeparators: [' ', ' '],
            data: data2
        });

        $('#drArticleCategory > option').prop("selected", true);
    }
    ...
    $('#drArticleCategory').select2({
        ...
        ajax: {
            ...
            delay: 0,
            data: function (params) {
                var query = { key: params.term, ctrl: "select2", multilevel: "1", table: "tblCategories", moduls: "article", t: Math.random() }; return query;
            },
            processResults: function (data) {
                console.log(data);
                return { results: data };
    ...
    $('#drArticleCategory').change(function () {
        var idSelect = $(this).select2("val");
        $('#categoryid').val(idSelect);
