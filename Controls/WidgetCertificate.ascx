<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WidgetCertificate.ascx.cs" Inherits="Controls_WidgetCertificate" %>
<%@ Import Namespace="System.Data" %>
<%
    DataTable dt = SqlHelper.SQLToDataTable("tblHome_Certificate", "Image_1,Name,Alt,Link", Utils.CreateFilterHide, "Sort");
