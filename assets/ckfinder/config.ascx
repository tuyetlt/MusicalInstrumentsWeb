...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = Globals.BaseUrl + "upload/";
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip", "webp" };
        ...
        type = ResourceType.Add( "sp" );
        type.Url = BaseUrl + "pro/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "pro/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png", "webp" };
        type.DeniedExtensions = new string[] { };
